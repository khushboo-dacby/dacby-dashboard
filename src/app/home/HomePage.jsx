...
export default function HomePage() {
  ...
  return (
    // Outer wrapper: full screen, centers the single button in the middle.
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      {/* This is the ONLY button on the page, as requested. */}
      <button
        onClick={openModal}
        className="flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-white font-semibold hover:bg-blue-700"
      >
      ...
      {isModalOpen && (
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 px-20">
